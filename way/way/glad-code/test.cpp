...
int main()
{
    ...
    Model model_merge("res/test/model1.obj");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glm::mat4 model;
        model = glm::translate(model, glm::vec3(0.0f, 0.18f, 0.0f));
		...
		RenderText(textShader, "This is sample text", SCR_WIDTH / 2, SCR_HEIGHT / 2, 1.0f, glm::vec3(1.0, 1.0f, 1.0f));
